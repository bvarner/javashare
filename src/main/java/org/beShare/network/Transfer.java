...
/**
 * Defines an abstract class for transferring files. Actuall work should be done by subclasses. Operational
 * utility functions are provided by this class.
 * @version 2.0
 * @author Bryan Varner
 */
public abstract class Transfer extends Thread implements MessageListener,
